...
<template>
    <div class="test">
        ...
        <div class="grid-default">
            alert 모달 샘플(구현중)
            <EpButton :width="'7rem'" :height="'4rem'" :color="'var(--color2)'" :fontColor="'var(--color1)'"
        ...
        <div>
            ...
            <EpButton :width="'7rem'" :height="'4rem'" :color="'var(--color4)'" :label="'common button'"
                @click="test" />
        </div>
        <div>

            <EpButton :width="'7rem'" :height="'4rem'" :color="'var(--color5)'" :label="'common button'"
                @click="test" />
        </div>
        <EpButton :width="'10rem'" :height="'10rem'" :color="'var(--color2)'" :label="'common button'" @click="test" />
        <EpButton :width="'10rem'" :height="'10rem'" :color="'var(--color3)'" :label="'common button'" @click="test" />
        <EpButton :width="'10rem'" :height="'10rem'" :label="'common button'" @click="test" />

        <AlertMdl :isOn='isOn' :message="message" @confirm="confirm" @cancel="cancel"/>
    </div>
</template>
<script>
